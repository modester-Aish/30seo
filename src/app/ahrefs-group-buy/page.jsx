...
const page = () => {
  return (
    <>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              <div className="banner-inner pb-5">
                <h2 className="title text-white">AHREFS Group Buy</h2>
                <p className="content text-white mx-auto" style={{maxWidth:'720px'}}>Affordable Ahrefs group buy – Rank higher, grow faster!</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 mb-4 mb-lg-0">
                <div className="about-thumb-inner pe-xl-4">
                  <img className="main-img w-100 border-radius-5" src="/assets/img/ahref.png" alt="Ahrefs group buy" />
                </div>
              </div>
              <div className="col-lg-6">
                <div className="section-title mb-3">
                  <h6 className="sub-title-sky-blue">AHREFS Group Buy</h6>
                  <h2 className="title">Grab the #1 SEO tool at an unbeatable cost</h2>
                </div>
                <p className="content mb-2">Affordable Ahrefs group buy – Rank higher, grow faster!</p>
                <ul className="single-list-inner style-check style-heading style-check mb-3">
                  <li>Unlimited Access</li>
                  <li>Instant Access with one click</li>
                  <li>100% Money Back Guarantee</li>
                  <li>Ahrefs Group Buy + 20 Bounce Tools</li>
                </ul>
                <h3 className="mb-2">$20 <sub>/ Month</sub></h3>
      ...
      <ToolWorkProcess
        toolTitle={"AHREFS Group Buy"}
        points={[
          'Ahrefs Group Buy at Cheap Prices With Bounce Tools Unlimited',
